        ...
        inject.type === InjectType.INJECT && [
          ...
          m(ModalPanel, {
            options: {
              onCloseEnd: () => {
                version++;
                newInject.templateId = undefined;
              },
            },
            fixedFooter: true,
            onCreate: (modal) => {
            ...
            buttons: [
              ...
              {
                label: 'Create',
                disabled: !(newInject.title && newInject.templateId),
                onclick: async () => {
                  isEditing = true;
                  options && options.editing && options.editing(isEditing);
